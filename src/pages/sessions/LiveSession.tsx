...
export const LiveSession = () => {
  ...
  const handleTriggerQuestion = (question: Question) => {
    setActiveQuestion(question);
    setShowQuestions(false);
    toast.success(`Question triggered: ${question.question.substring(0, 50)}...`);
    // In real app, this would emit to Socket.IO to send question to all students
  };

  const handleQuestionAnswer = (answerIndex: number) => {
    // In real app, this would send the answer to the backend
